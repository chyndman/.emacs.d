...
(defun init-bg-color (face color)
  (set-face-background face (alist-get color colors)))
(defun init-fg-color (face color)
  (set-face-foreground face (alist-get color colors)))

;; Syntax Theme
(init-bg-color 'default 'background)
(init-fg-color 'default 'foreground)
(init-fg-color 'font-lock-builtin-face 'magenta)
(init-fg-color 'font-lock-comment-delimiter-face 'green)
(init-fg-color 'font-lock-comment-face 'green)
(init-fg-color 'font-lock-constant-face 'green)
(init-fg-color 'font-lock-doc-face 'green)
(init-fg-color 'font-lock-function-name-face 'cyan)
(init-fg-color 'font-lock-keyword-face 'blue)
(init-fg-color 'font-lock-preprocessor-face 'magenta)
(init-fg-color 'font-lock-string-face 'red)
(init-fg-color 'font-lock-type-face 'cyan)
